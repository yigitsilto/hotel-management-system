...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'email' => 'E-posta Adresi',
        'pan' => 'Kredi Kartı Numarası',
        'Ecom_Payment_Card_ExpDate_Month' => 'Kredi Kartı Ay',
        'Ecom_Payment_Card_ExpDate_Year' => 'Kredi Kartı Yıl',
        'password' => 'Parola',
        ...
        'guests.0.tc' => 'TC Kimlik Numarası',
        'guests.0.name' => 'İsim',
        'guests.0.age' => 'Yaş',
        'guests.1.tc' => 'TC Kimlik Numarası',
        'guests.1.name' => 'İsim',
        'guests.1.age' => 'Yaş',
        'guests.2.tc' => 'TC Kimlik Numarası',
        'guests.2.name' => 'İsim',
        'guests.2.age' => 'Yaş',
        'guests.3.tc' => 'TC Kimlik Numarası',
        'guests.3.name' => 'İsim',
        'guests.3.age' => 'Yaş',
        'guests.4.tc' => 'TC Kimlik Numarası',
        'guests.4.name' => 'İsim',
        'guests.4.age' => 'Yaş',
        'guests.5.tc' => 'TC Kimlik Numarası',
        'guests.5.name' => 'İsim',
        'guests.5.age' => 'Yaş',
