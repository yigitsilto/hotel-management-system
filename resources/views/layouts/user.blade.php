...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link  {{ Route::is('user-dashboard') ? 'active' : '' }}" href="{{route('dashboard')}}">
                    <div
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::is('user-reservation.myReservations') ? 'active' : '' }} "
                   href="{{route('user-reservation.myReservations')}}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Sayfalar</a>
                    </li>
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><a href="{{route('dashboard')}}">Anasayfa</a></li>
                </ol>
                <a href="{{route('dashboard')}}" class="font-weight-bolder mb-0">Anasayfa</a>
            </nav>
