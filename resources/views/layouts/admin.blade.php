        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::is('hotel-management.index') ? 'active' : '' }} " href="{{route('hotel-management.index')}}">
                    ...
                    <span class="nav-link-text ms-1">Otel Yönetimi</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            @if(auth()->user()->role == 'ADMIN')
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('import.file.page') ? 'active' : '' }}  " href="{{route('import.file.page')}}">
                        ...
                        <span class="nav-link-text ms-1">Toplu Kullanıcı Ekle</span>
                    </a>
                </li>
            @endif
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::is('reservation.index') ? 'active' : '' }} " href="{{route('reservation.index')}}">
                    ...
                    <span class="nav-link-text ms-1">Rezervasyon Talepleri</span>
                </a>
            </li>

{{--            <li class="nav-item">--}}
{{--                <a class="nav-link {{ Route::is('groupByList') ? 'active' : '' }} " href="{{route('groupByList')}}">--}}
{{--                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">--}}
{{--                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">--}}
{{--                            <title>credit-card</title>--}}
{{--                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
...
{{--                        </svg>--}}
{{--                    </div>--}}
{{--                    <span class="nav-link-text ms-1">Rezervasyon Doluluk Oranı</span>--}}
{{--                </a>--}}
{{--            </li>--}}
           ...
           @endif
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::is('transaction-management.index') ? 'active' : '' }}  " href="{{route('transaction-management.index')}}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>credit-card</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">Ödeme Bilgileri</span>
                </a>
            </li>
