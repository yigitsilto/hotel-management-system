                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body p-3">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="check_in_date">Toplam Ücret:</label>
                                        <input type="text" class="form-control" id="total_price"
                                               name="total_price" wire:model.live="total_price">
                                        @error('total_price') <span
                                            class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                </div>
                            ...
                            <div class="pt-3">
                                @if($canDoReservation)
                                    <button style="width: 100%" class="btn btn-primary btn-lg "
                                        ...
                                        <span class="ms-1">Rezervasyonu Kaydet</span>
                                    </button>

                                @else

                                    <button type="button" style="width: 100%" class="btn btn-danger btn-lg" role="tab"
                                            aria-selected="true">
                                        <svg class="text-dark" width="16px" height="16px" viewBox="0 0 42 42"
                                             version="1.1"
                                             xmlns="http://www.w3.org/2000/svg">
